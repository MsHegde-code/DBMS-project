...
<head>
  ...
  <?php include 'css/test-in-index.css'; ?>
  </style>
  <?php 
  $notice="";
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
         <div class="form-group">
            ...
            <input type="text" placeholder="Product name" name="name" class="form-control" id="some" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" placeholder="Price (in Rupees)" name="price"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Supplier Name</label>
            <input type="text" name="supplier" placeholder="Medicine Supplier"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Medicine Company Name</label>
            <input type="text" name="company" placeholder="Medicine Company"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
