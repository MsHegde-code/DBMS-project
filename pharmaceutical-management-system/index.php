...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div class="flex" style="padding: 3px 7px;margin:5px 2px;">
    ...
    <div style="color:lightgreen;font-size: 13pt;padding: 14px 7px;margin-left: 11px;margin-top: 6px"><?php echo ucfirst($user['name']); ?></div>
  </div>
...
<div class="marginLeft" >
  <div style="color:white;background:#357CA5" >
    <div class="pull-right flex rightAccount" style="padding-right: 11px;padding: 11px;">
      <div><img src="photo/<?php echo $user['pic'] ?>" style='width: 38px;height: 35px;' class='img-circle'></div>
      <div style="padding: 8px;padding-right: 25px"><?php echo ucfirst($user['name']) ?></div>
    </div>
    <div class="clear"></div>
  </div>
  ...
  ?>
    ...
    <a href="inventeries.php?catId=<?php echo $row['id'] ?>"><div class="box2 col-md-3">
     <div class="center"> <img src="photo/<?php echo $row['pic'] ?>" style="width: 155px;height: 122px;" class='img-thumbnail'></div>
      <hr style="margin: 7px;">
      <span style="padding: 11px"><strong style="font-size: 10pt">Name</strong><span class="pull-right" ><?php echo $row['name'] ?></span></span>
      <hr style="margin: 7px;">
      <span style="padding: 11px"><strong style="font-size: 10pt">Available Qty</strong><span class="pull-right" ><?php echo $row2['count(*)']; ?></span></span>
    </div></a>
  <?php
    }
   ?>
