...
<body style="background: url('photo/login.jpg');background-size: 100%">
	<div class="login-box">
  <div class="well well-sm center" style="width: 25%;margin: auto;padding:4px 11px;margin-top: 150px;text-align: center;background: rgba(10,15,25,0.9);border-radius:15px">
  	<h3 class="center" style="color:  rgba(232,230,230,0.9);padding-bottom: 4px">Pharmacy Management</h3>
  </div>
  <!-- /.login-logo -->
